...
export const LoanTerms: FC<LoanTermsProps> = ({ loan }) => (
  <div className="mb-3">
    <div className="w-full">
      <ul className="grid grid-cols-2 auto-cols-auto justify-items-center gap-y-3 items-center gap-6 lg:grid-cols-[1fr_minmax(0,_1fr)_1fr] lg:grid-flow-col lg:grid-rows-3 ">
